 ...
 */(function(a,b){if('undefined'!=typeof module)module.exports=b();else if('function'==typeof define&&'object'==_typeof(define.amd))define(b);else{var c=this||window;c[a]=b()}})('XscrollController',function(){function XscrollControllerClass(e,f){function g(a){var b=j.wrapperDom,f=j.innerDom,g=f.clientHeight-b.clientHeight;if(a=a||window.event,a.stopPropagation(),a.cancelBubble=!0,!(b.scrollTop<g&&0<b.scrollTop)){// vertical scroll on middle
...
return XscrollControllerClass.prototype={constructor:XscrollControllerClass,setOptions:function c(a){var b=a.allowXScroll;void 0===b?void 0===this.allowXScroll&&(this.allowXScroll=!0):this.allowXScroll=b}},function(a,b,c){var d='object'===('undefined'==typeof HTMLElement?'undefined':_typeof(HTMLElement))?function(a){return a instanceof HTMLElement}:function(a){return a&&'object'===('undefined'==typeof a?'undefined':_typeof(a))&&1===a.nodeType&&'string'==typeof a.nodeName};if(!d(a)||!d(b))throw new Error('[XscrollController]: parameters should be DOM Node');return new XscrollControllerClass(a,b,c)}});
